...
import com.android.voyce.databinding.FragmentContactBinding;
...
public class MusicianContactFragment extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
       ...
       mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_contact, container, false);
        ...
        mBinding.musicianFacebookUrl.setLinkTextColor(Color.WHITE);
        mBinding.musicianInstagramUrl.setLinkTextColor(Color.WHITE);
        mBinding.musicianTwitterUrl.setLinkTextColor(Color.WHITE);
        ...
        viewModel.getMusician().observe(this, new Observer<User>() {
            ...
            public void onChanged(@Nullable User user) {
                if (user != null) {
                    ...
                    Linkify.addLinks(mBinding.musicianInstagramUrl, Pattern.compile(getString(R.string.instagram)),
                            user.getInstagram_url(), null, mTransformFilter);
                    Linkify.addLinks(mBinding.musicianFacebookUrl, Pattern.compile(getString(R.string.facebook)),
                            user.getFacebook_url(), null, mTransformFilter);
                    Linkify.addLinks(mBinding.musicianTwitterUrl, Pattern.compile(getString(R.string.twitter)),
